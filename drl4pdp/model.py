...
class DRL4TSP(nn.Module):
    ...
    dynamic_size: int > 1
        ...
        (e.g. 2 for the PDP which has (load, demand) attributes. The TSP doesn't
    ...
    def forward(self, static, dynamic, decoder_input=None, last_hh=None):
        ...
        dynamic: Array of size (batch_size, feats, num_cities)
            Defines the elements to consider as static. For the PDP, this can be
        ...
        for _ in range(max_steps):
            ...
            if self.update_fn is not None:
                ...
                # Since we compute the PDP in minibatches, some tours may have
