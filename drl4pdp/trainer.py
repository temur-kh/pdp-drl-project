...
def train_pdp(args):
    ...
    # Goals from paper:
    # PDP10, Capacity 20:  4.84  (Greedy)
    # PDP20, Capacity 30:  6.59  (Greedy)
    # PDP50, Capacity 40:  11.39 (Greedy)
    # PDP100, Capacity 50: 17.23  (Greedy)

    from tasks import pdp
    from tasks.pdp import VehicleRoutingDataset, update_mask, update_dynamic
    ...
    kwargs['reward_fn'] = pdp.reward
    kwargs['render_fn'] = pdp.render
    ...
    out = validate(test_loader, actor, pdp.reward, pdp.render, test_dir, num_plot=5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', default='pdp')
    ...
    #args.checkpoint = os.path.join('pdp', '10', '12_59_47.350165' + os.path.sep)
